...
SYNTHESIA_KEY = os.environ.get("SYNTHESIA_KEY")
SYNTHESIA_URL = os.environ.get("SYNTHESIA_URL")
...
ADMINS = [("Anser Ali", "workwithfabtechsol@gmail.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Plate prep API",
    "DESCRIPTION": "Plate prep API",
    "VERSION": "1.0.0",
